import os
import csv
listOfFolders = os.listdir(r'C:\Users\akhil\OneDrive\Desktop\skincancer\src\static\archive\train\\')


static_path=r"C:\Users\akhil\OneDrive\Desktop\skincancer\src\static\\"
...
for foldername in listOfFolders:    #list all disease folders
    for filename in os.listdir(r'C:\Users\akhil\OneDrive\Desktop\skincancer\src\static\archive\train\\'+foldername): #iterate images from disease folder
        # print("bbb",filename)
        import numpy as np
        from skimage import io, color, img_as_ubyte
        from skimage.feature import greycomatrix, greycoprops

        rgbImg = io.imread(r'C:\Users\akhil\OneDrive\Desktop\skincancer\src\static\archive\train\\'+foldername+ "\\" + filename)    #images of disease in rgb
